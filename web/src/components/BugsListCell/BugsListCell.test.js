...
import { Loading, Empty, Failure, Success } from './BugsListCell'

describe('BugsListCell', () => {
  afterEach(() => {
    cleanup()
  })
  ...
  it('Success renders successfully', () => {
    render(
      <Success userExample={{ bugsList: { objectKey: 'objectValue' } }} />
    )
    expect(
      screen.queryByText('{"bugsList":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})
