...
import { Loading, Empty, Failure, Success } from './CritterListCell'

describe('CritterListCell', () => {
  afterEach(() => {
    cleanup()
  })
  ...
  it('Success renders successfully', () => {
    render(
      <Success userExample={{ critterList: { objectKey: 'objectValue' } }} />
    )
    expect(
      screen.queryByText('{"critterList":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})
